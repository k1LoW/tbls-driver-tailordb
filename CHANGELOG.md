...
## [v0.2.6](https://github.com/k1LoW/tbls-driver-tailordb/compare/v0.2.5...v0.2.6) - 2025-06-30
### Other Changes
...
- chore(deps): bump the dependencies group across 1 directory with 2 updates by @dependabot in https://github.com/k1LoW/tbls-driver-tailordb/pull/24
- chore(deps): bump the dependencies group with 2 updates by @dependabot in https://github.com/k1LoW/tbls-driver-tailordb/pull/25
- chore(deps): bump the dependencies group across 1 directory with 3 updates by @dependabot in https://github.com/k1LoW/tbls-driver-tailordb/pull/28
- chore(deps): bump cuelang.org/go from 0.13.1 to 0.13.2 in the dependencies group by @dependabot in https://github.com/k1LoW/tbls-driver-tailordb/pull/29
